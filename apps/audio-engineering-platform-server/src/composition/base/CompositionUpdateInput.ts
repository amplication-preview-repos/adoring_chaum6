...
class CompositionUpdateInput {
  @ApiProperty({
    required: false,
    type: () => AudioFileUpdateManyWithoutCompositionsInput,
  })
  @ValidateNested()
  @Type(() => AudioFileUpdateManyWithoutCompositionsInput)
  @IsOptional()
  @Field(() => AudioFileUpdateManyWithoutCompositionsInput, {
    nullable: true,
  })
...
export { CompositionUpdateInput as CompositionUpdateInput };
